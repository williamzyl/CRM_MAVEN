...
<SCRIPT language=javascript>
	...
	function deleteComfirm(saleVisitId) {
		if(confirm("确认删除？")){
			window.location.href="${pageContext.request.contextPath }/saleVisit_delete?visitId="+saleVisitId;
		}
	}
										...
										<TABLE cellSpacing=0 cellPadding=2 border=0>
											<TBODY>
												<TR>
													<TD>客户名称：</TD>
													<TD>
														<input type="hidden" name="customer.custId" id="custId" value="${param['customer.custId']}" />
														<INPUT class=textbox style="WIDTH: 80px" maxLength=50 name="custName"  id="custName" value="${param['custName']}" >
										...
										<TABLE id=grid
											...
											<TBODY>
												...
												<TR
													...
													<TD><s:property value="visitInterviewee" /></TD>
													<TD><s:property value="visitAddr" /></TD>
													<TD><s:property value="visitDetail" /></TD>
													<TD><s:property value="visitNextTime_s" /></TD>
													<TD>
															<!-- 没有传递参数,显示删除和修改操作 -->
														<a href="${pageContext.request.contextPath }/saleVisit_update?visitId=<s:property value="visitId" />">修改</a>
														&nbsp;&nbsp;
														<a href="javascript:void(0)" onclick="deleteComfirm('<s:property value="visitId" />')" >删除</a>
													</TD>
												</TR>
												</s:iterator>
								...
								<TR>
									<TD><SPAN id=pagelink>
											<DIV
												...
												共[<B><s:property value="#pageBean.totalSize" /> </B>]条记录,[<B><s:property value="#pageBean.totalPage" /></B>]页
