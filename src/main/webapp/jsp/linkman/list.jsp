...
<SCRIPT language=javascript>
	...
	function deleteLinkMan(linkmanId) {
		if(confirm("确认删除？")){
			window.location.href="${pageContext.request.contextPath }/linkman_delete?lkmId="+linkmanId;
		}
											...
											<TBODY>
												<TR>
													...
													<TD>
														...
														style="WIDTH: 80px" maxLength=50 name="lkmName" value="${param['lkmName']}">
													</TD>
													<TD>客户名称：</TD>
													<TD>
										...
										<TABLE id=grid
											...
											<TBODY>
												...
												<TR
													...
													<TD><s:property value="#linkMan.lkmGender_s" /></TD>
													<TD><s:property value="#linkMan.lkmPhone" /></TD>
													<TD><s:property value="#linkMan.lkmMobile" /></TD>
													<TD>
													<a href="${pageContext.request.contextPath }/linkman_update?lkmId=<s:property value="#linkMan.lkmId" />">修改</a>
													&nbsp;&nbsp;
													<a href="javascript:;" onclick="deleteLinkMan(<s:property value="#linkMan.lkmId" />)">删除</a>
													</TD>
												</TR>
												</s:iterator>
